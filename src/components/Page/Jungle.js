      ...
      <h1 class=" text-xl-center text-custom-jungle text-decoration-underline font-weight-bold" style={{marginBottom: "50px", marginTop: "25px"}}>La Jungle</h1>
        ...
        <div class="row justify-content-center mb-2 mt-5">
          ...
          <div class="col-lg-5 mt-5 border">
            <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">L'Empereur d'Amazonie</h3>
              <h5 class="text-light text-left mt-4">Le tamarin empereur est un petit primate au faciès particulier, largement reconnaissable à son imposante moustache blanche semblable à celle de l'empereur allemand Guillaume II qui lui value son appelation.Il pèse de 300g à 500 pour une taille de 23cm a 25cm et une queue de 40cm.</h5>
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">Le Jaguar</h3>
            <h5 class="text-light text-left mt-4">Troisième plus grand félin au monde, le jaguar fascine tant pour sa beauté que sa puissance. Il est aussi à l'aise dans l'eau que sur la terre ferme.Sa corpulence imposante lui permet de s'attaquer à des proies qui font parfois le double de sa taille, il est dénommé "celui qui tue en un bond".Cette espèce est quasi menacée de disparition. Mesurant jusqu'à 1,85m pour un maximum de 150kg. Vitesse 80km/h !</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">La Panthère Noire</h3>
            <h5 class="text-light text-left mt-4">Contrairement à ce que l'on croit, la panthère n'est pas une espèce en tant que telle. L'animal est noir en raison d'une anomalie de coloration due à la mélanine. Cet animal est rare car il ne représente qu'un trés faible pourcentage des naissance chez les léopards et les jaguars. Cependant la population d'Asie du Sud-Est et de l'Inde compte 11% de la population de Léopards noire.Elle mesure 1,2m pour 50kg et possède une vitesse de pointe de 60km/h</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">Le Dauphin Rose</h3>
            <h5 class="text-light text-left mt-4">Peu connu et doté d'un nom amusant, le dauphin rose est longtemps resté une véritable énigme pour les scientifiques.L'animal est pourtant essentiellement gris, avec parfois des touches rosées sur le ventre. Il devient surtout rose avec l'âge !C'est le plus grand Dauphin d'eau douce.Le dauphin rose est un cétacé de la famille des Inia. Il mesure entre 2m et 2,80m et pèse entre 100kg et 150kg. <br/>C'est une espèce menacée</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">Le Toucan</h3>
            <h5 class="text-light text-left mt-4">Le Toucan Toco appartient à l'ordre des piciformes dont il est le plus grand représentant ! Il se distingue par son énorme bec courbé et coloré de rouge, orange et jaune. Il mesure entre 58 et 64 cm de long et pèse entre 500 et 850 grammes. C'est un animal plutot sociable.</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">L'Ara Rouge'</h3>
            <h5 class="text-light text-left mt-4">Le rouge écarlate domine chez ce grand perroquet très coloré. Il porte une grande tache jaune.Il y a peu de différences physiques entre le mâle et la femelle. Par contre, les jeunes ont des yeux sombres alors que les adultes ont des yeux jaune clair, presque blanc.Il mesure entre 84 et 90cm pour un poid de 900g à 1,5kg</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">Le Tapir</h3>
            <h5 class="text-light text-left mt-4">Doté d'une petite trompe, nageant bien, le tapir joue un rôle essentiel dans la biodiversité de l'Amérique du sud. Il consomme de nombreuses graines qu'il dissémine avec ses déjections. Son puissant passage éclaircit les sous-bois, éliminant les arbustes, favorisant les plantes.Sa taille varie de 2m à 2,20m et son poids de 150 à 250kg.</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">Le Mille-Pattes Géant</h3>
            <h5 class="text-light text-left mt-4">Au royaume des mille-pattes, Scolopendra gigantea est le plus grand. Cet arthropode géant est connu pour sa morsure douloureuse et venimeuse capable de venir à bout d'espèces en tout genre. Il est le plus grand scolopendre du monde mesurant entre 25 et 30 centimêtres</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">La Grenouille Empoisonneuse</h3>
            <h5 class="text-light text-left mt-4">Aussi appelée Grenouille à flèche empoisonnée parce que les autochtones en tirent du venin dont ils badigeonnent leurs flèches de manière à ce que leurs proies tombent, inconscientes.À cause de sa couleur particulière, il s'agit d'une espèce parfaitement reconnaissable. Elle est caractérisée par sa petite taille, d'entre 3 et 4 cm de long, et une coloration de bandes noires et jaunes avec des petites taches noires.</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5 border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">Le Gorille</h3>
            <h5 class="text-light text-left mt-4"> Les gorilles sont les plus grands des singes et probablement les plus impressionnants. Pourtant, loin de l'image véhiculée par la littérature et le cinéma, ce sont des animaux pacifiques et timides. Ils sont aussi nos plus proches cousins après les chimpanzés et les bonobos.Il mesure d'1,40m à 2m (debout) pour un poids moyen de 250kg.Ils sont malheureusement en voie de disparition dût à la réduction de leur habitat et du braconage.</h5>
      ...
      <div class="row justify-content-center mb-2 mt-5">
        ...
        <div class="col-lg-5 mt-5  border">
          <h3 class="text-xl text-align-center text-light text-decoration-underline mt-3">L'Orang Outans</h3>
            <h5 class="text-light text-left mt-4">Le nom « orang-outan » vient du malais orang hutan, qui signifie littéralement « homme de la forêt ». Ce grand singe a élu domicile à la cime des arbres et parcourt inlassablement la canopée.Leurs bras puissants sont plus longs que leurs jambes et peuvent atteindre 2 mètres. Ils sont capables de toucher leurs chevilles lorsqu'ils se tiennent debout.Il mesure d'1,10m à 1,40m pour un poids variant entre 40 et 90kg. </h5>
