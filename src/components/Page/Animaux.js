...
export default function Animaux() {
  ...
  <div class="card border-secondary ">
    ...
    <div class="card-body">
      ...
      <p></p>
      <div class="card-footer">Alligator d'Amérique, Crocodile, Caiman à lunettes, Couleuvre à colier, Anaconda vert, Buffle d'Afrique, Faucon pélerin, Flamant rose, Raton laveur, Salamandre tigrée, Rainette de white, Bec à Sabot du Nil !
    </div>
    </div>
  </div>
