...
export default function Accueil() {
 ...
 <>
      ...
      <h2 class="text-center"><a class="btn btn-outline-primary " href="services" role="button">Nos services de réparations</a></h2>
      <div class="row justify-content-center">
        <div class="col-6 col-md-7">
          <img src={Reparation} class="img-fluid border border-primary rounded mb-3 " alt="reparation" />    
        </div>
        <hr></hr>
        <h2 class="text-center"><a class="btn btn-outline-light " href="services" role="button">Nos services d'entretiens</a></h2>
        <div class="col-6 col-md-7">      
